...
void handleRoot() {
  String html = "<!DOCTYPE html>"
                ...
                "}"
                ".button {"
                "  background-color: " + String(ledState ? "green" : "#0066cc") + ";"
                "  color: white;"
                "  padding: 15px 32px;"
                "  text-align: center;"
                ...
                "</head>"
                "<body>"
                "<h1>TRIOE LED Control</h1>"
                "<p>LED is currently " + String(ledState ? "ON" : "OFF") + "</p>"
                "<a href='/toggle'><button class='button'>" + String(ledState ? "Turn OFF" : "Turn ON") + "</button></a>"
                "</body>"
                "</html>";
